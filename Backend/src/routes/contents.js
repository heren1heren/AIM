...
router.get('/classes/:classId', authorize(['admin', 'teacher', 'student']), contentController.getContentsByClassId); // Admin, teacher, and student can get content by class ID
